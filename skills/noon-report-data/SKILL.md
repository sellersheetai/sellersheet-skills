...
description_zh: "noon 订单、noon 财务/交易明细、FBN 库存账龄、noon 商品浏览与销量、noon 店铺报表。"
description_en: "Use when working with noon.com (noon Partners) report data that SellerSheet ingests on a schedule — querying…"
