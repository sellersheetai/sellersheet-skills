# v1 `targets` - FULL field catalog (generated; do not hand-edit)
...
- `matchTypeFilter`: {include*: array<enum (18 values - see V1-GA-ENUMS.md)>}
- `maxResults`: integer
- `nativeLanguageLocaleFilter`: {include*: array<enum (166 values - see V1-GA-ENUMS.md)>}
...
- `targetTypeFilter`: {include*: array<enum (27 values - see V1-GA-ENUMS.md)>}
...
- `nextToken`: string
- `stateFilter`: {include*: array<enum: ARCHIVED | ENABLED | PAUSED>}
- `targetTypeFilter`: {include*: array<enum (26 values - see V1-GA-ENUMS.md)>}
