# v1 `campaigns` - FULL field catalog (generated from Amazon's official OpenAPI specification; do not hand-edit)
...
- `campaigns[].countries`: array<enum (23 values - see ENUMS.md)>
- `campaigns[].endDateTime`: string
...
- `campaigns[].countries`: array<enum (21 values - see ENUMS.md)>
- `campaigns[].endDateTime`: string
- `campaigns[].marketplaceScope` **REQUIRED**: enum: SINGLE_MARKETPLACE
- `campaigns[].marketplaces`: array<enum (21 values - see ENUMS.md)>
- `campaigns[].name` **REQUIRED**: string
- `campaigns[].portfolioId`: string
- `campaigns[].startDateTime` **REQUIRED**: string
- `campaigns[].state` **REQUIRED**: enum: ENABLED | PAUSED
